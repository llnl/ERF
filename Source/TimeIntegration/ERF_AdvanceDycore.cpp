                         ...
                         const Real dt_advance, const Real old_time)
{
    ...
    {
        // Rho
        PlaneAverage r_ave(&(state_old[IntVars::cons]), fine_geom, solverChoice.ave_plane, true);
        ...
        IntVect ng_c = state_old[IntVars::cons].nGrowVect();
        ...
        // Rho * Theta
        PlaneAverage t_ave(&(state_old[IntVars::cons]), fine_geom, solverChoice.ave_plane, true);
        ...
        // U and V velocity
        PlaneAverage u_ave(&(xvel_old), fine_geom, solverChoice.ave_plane, true);
        PlaneAverage v_ave(&(yvel_old), fine_geom, solverChoice.ave_plane, true);
        ...
        IntVect ng_u = xvel_old.nGrowVect();
        IntVect ng_v = yvel_old.nGrowVect();
